...
export const jaEhPizzaMenu: RestaurantMenu = {
  ...
  pizzas: [
    { slug: 'mussarela', category: 'classics', sizesAvailable: ['grande'], price: 43.9, featured: false, image: '/pizza-mussarela.png' },
    ...
    { slug: 'portuguesa', category: 'classics', sizesAvailable: ['grande'], price: 52.9, featured: true, image: '/pizza-portuguesa.png' },
    { slug: 'marguerita', category: 'classics', sizesAvailable: ['grande'], price: 47.9, featured: true, image: '/pizza-marguerita.png' },
    ...
    { slug: 'bacon', category: 'classics', sizesAvailable: ['grande'], price: 49.9, featured: false, image: '/pizza-bacon.png' },
    { slug: 'frango', category: 'chicken-and-meat', sizesAvailable: ['grande'], price: 47.9, featured: false, image: '/images/pizza/frango.jpg' },
    { slug: 'frango-com-catupiry', category: 'chicken-and-meat', sizesAvailable: ['grande'], price: 53.9, featured: true, image: '/pizza-frango-com-catupiry.png' },
    ...
    { slug: 'peperoni', category: 'chicken-and-meat', sizesAvailable: ['grande'], price: 55.9, featured: true, image: '/pizza-pepperoni.png' },
    ...
    { slug: 'quatro-queijos', category: 'specials', sizesAvailable: ['grande'], price: 57.9, featured: true, image: '/pizza-4-queijos.png' },
