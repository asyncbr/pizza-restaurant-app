const ptBRDictionary = {
  ...
  productCatalog: {
    metaTitle: 'Jae Pizzas | Cardapio completo',
    metaDescription: 'Confira o cardapio completo da Jae Pizzas com sabores classicos, especiais e pedido rapido por WhatsApp.',
    eyebrow: 'Cardapio completo',
    title: 'Sabores da casa para pedir sem perder tempo.',
    description: 'Escolha entre pizzas classicas, especiais e combinacoes que resolvem a noite com massa artesanal, cobertura generosa e pedido rapido por WhatsApp.',
    ...
    serviceBadge: 'Entrega e retirada',
    serviceNote: 'Pizzas grandes com 8 fatias. Consulte taxa e tempo de entrega para o seu bairro.',
  },
  images: {
